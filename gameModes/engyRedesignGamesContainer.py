...
import gameModes.engyRedesignGame
reload(gameModes.engyRedesignGame)
from gameModes.engyRedesignGame import engyRedesignGameClass

class engyRedesignGamesContainerClass(gamesContainerClass):
    '''Class for custom nomads games'''

    def __init__(self, db, parent = None):
        super(engyRedesignGamesContainerClass, self).__init__("engyredesign", "engy Redesign", db, parent)
    ...
    def addBasicGame(self, player, newgame, gamePort):
        ...
        ngame = engyRedesignGameClass(gameUuid, self) 
