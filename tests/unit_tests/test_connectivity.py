...
from server.connectivity import ConnectivityTest, Connectivity, ConnectivityState
...
async def test_connectivity_defaults_to_proxy(loop):
    ...
    with ConnectivityTest(game_connection, '127.0.0.1', 6112, identifier) as peer_test:
