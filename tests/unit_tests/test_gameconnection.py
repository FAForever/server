...
async def test_handle_message_GameState_idle_adds_connection(
    game: Game,
    game_connection: GameConnection,
    players
):
    ...
    await game_connection.handle_message({
        "command": "GameState",
        "args": ["Idle"]
    })
...
async def test_handle_message_GameState_idle_non_searching_player_aborts(
    game_connection: GameConnection,
    players
):
    game_connection.player = players.hosting
...
async def test_handle_message_GameState_lobby_sends_HostGame(
    game: Game,
    game_connection: GameConnection,
    event_loop,
    players
...
async def test_handle_message_GameState_lobby_calls_ConnectToHost(
    game: Game,
    game_connection: GameConnection,
    event_loop,
    players
...
async def test_handle_message_GameState_lobby_calls_ConnectToPeer(
    game: Game,
    game_connection: GameConnection,
    event_loop,
    players
...
async def test_handle_message_GameState_lobby_calls_abort(
    game: Game,
    game_connection: GameConnection,
    event_loop,
    players
...
async def test_handle_message_GameState_launching_calls_launch(
    game: Game,
    game_connection: GameConnection,
    players
):
...
async def test_handle_message_GameState_ended_calls_on_connection_lost(
    game_connection: GameConnection
):
...
async def test_handle_message_PlayerOption(game: Game, game_connection: GameConnection):
    await game_connection.handle_message({
...
async def test_handle_message_PlayerOption_malformed_no_raise(game_connection: GameConnection):
    await game_connection.handle_message({
        "command": "PlayerOption",
...
async def test_handle_message_PlayerOption_not_host(
    game: Game,
    game_connection: GameConnection,
    players
):
...
async def test_handle_message_GameMods(game: Game, game_connection: GameConnection):
    await game_connection.handle_message({
        "command": "GameMods",
        "args": ["uids", "foo baz"]
    })
...
async def test_handle_message_GameMods_activated(game: Game, game_connection: GameConnection):
    game.mods = {"a": "b"}
    await game_connection.handle_message({
        "command": "GameMods",
        "args": ["activated", 0]
...
async def test_handle_message_GameMods_unknown(game_connection: GameConnection):
...
async def test_handle_message_GameMods_not_host(
    game: Game,
    game_connection: GameConnection,
    players
):
...
async def test_handle_message_GameMods_post_launch_updates_played_cache(
    game: Game,
    game_connection: GameConnection,
    database
):
...
async def test_handle_message_AIOption(game: Game, game_connection: GameConnection):
    await game_connection.handle_message({
        "command": "AIOption",
...
async def test_handle_message_AIOption_not_host(
    game: Game,
    game_connection: GameConnection,
    players
):
...
async def test_handle_message_ClearSlot(game: Game, game_connection: GameConnection):
    await game_connection.handle_message({
        "command": "ClearSlot",
        "args": [1]
    })
...
async def test_handle_message_ClearSlot_not_host(
    game: Game,
    game_connection: GameConnection,
    players
):
...
async def test_handle_message_GameResult_calls_add_result(game: Game, game_connection: GameConnection):
    game_connection.connect_to_host = CoroutineMock()
...
async def test_handle_message_GameOption(game: Game, game_connection: GameConnection):
...
async def test_handle_message_GameOption_not_host(
    game: Game,
    game_connection: GameConnection,
    players
):
...
async def test_handle_message_EnforceRating(game: Game, game_connection: GameConnection):
    await game_connection.handle_message({
...
async def test_handle_message_TeamkillReport(game: Game, game_connection: GameConnection, database):
    game.launch = CoroutineMock()
    await game_connection.handle_message({
...
async def test_handle_message_TeamkillHappened(game: Game, game_connection: GameConnection, database):
    game.launch = CoroutineMock()
    await game_connection.handle_message({
...
async def test_handle_message_TeamkillHappened_AI(game: Game, game_connection: GameConnection, database):
...
async def test_handle_message_GameEnded_ends_sim(
    game: Game,
    game_connection: GameConnection
):
    game.ended = False
...
async def test_handle_message_GameEnded_ends_game(
    game: Game,
    game_connection: GameConnection
):
    game.ended = True
...
async def test_handle_message_OperationComplete(ugame: Game, game_connection: GameConnection, database):
    """
...
async def test_handle_message_OperationComplete_invalid(ugame: Game, game_connection: GameConnection, database):
    """
        Sends an OperationComplete action to handle action and verifies that
    the `coop_leaderboard` table is updated accordingly.
...
async def test_handle_message_IceMsg(
    game_connection: GameConnection,
    player_service,
    player_factory
):
...
async def test_handle_message_IceMsg_for_non_existent_player(
    game_connection: GameConnection,
):
    # No exceptions raised
    await game_connection.handle_message({
...
async def test_handle_message_IceMsg_for_non_connected(
    game_connection: GameConnection,
    player_service,
    player_factory
):
...
async def test_handle_message_desync(game_connection: GameConnection):
...
async def test_handle_message_ignored(game_connection: GameConnection, action):
    # No exceptions raised
    await game_connection.handle_message({"command": action, "args": []})


async def test_handle_message_CHat_ignored(game_connection: GameConnection):
    # No exceptions raised
    await game_connection.handle_message({"command": "Chat", "args": ["Test"]})


async def test_handle_message_invalid(game_connection: GameConnection):
    game_connection.abort = CoroutineMock()
