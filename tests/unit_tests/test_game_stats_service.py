...
async def test_process_game_stats(game_stats_service, event_service, achievement_service, player, game):
    ...
    event_service.record_event.assert_any_call(EVENT_FALLEN_ACUS, 0, [])
    event_service.record_event.assert_any_call(EVENT_BUILT_AIR_UNITS, 1, [])
    event_service.record_event.assert_any_call(EVENT_FALLEN_AIR_UNITS, 2, [])
    event_service.record_event.assert_any_call(EVENT_BUILT_LAND_UNITS, 4, [])
    event_service.record_event.assert_any_call(EVENT_FALLEN_LAND_UNITS, 5, [])
    event_service.record_event.assert_any_call(EVENT_BUILT_NAVAL_UNITS, 33, [])
    event_service.record_event.assert_any_call(EVENT_FALLEN_NAVAL_UNITS, 11, [])
    event_service.record_event.assert_any_call(EVENT_FALLEN_TECH_1_UNITS, 12, [])
    event_service.record_event.assert_any_call(EVENT_FALLEN_TECH_2_UNITS, 13, [])
    event_service.record_event.assert_any_call(EVENT_FALLEN_TECH_3_UNITS, 14, [])
    ...
    event_service.record_event.assert_any_call(EVENT_FALLEN_EXPERIMENTALS, 19, [])
    event_service.record_event.assert_any_call(EVENT_BUILT_EXPERIMENTALS, 20, [])
    event_service.record_event.assert_any_call(EVENT_FALLEN_ENGINEERS, 21, [])
