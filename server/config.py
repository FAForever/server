...
LADDER_SEARCH_EXPANSION_START = int(os.getenv('LADDER_SEARCH_EXPANSION_START', 60 * 5))
LADDER_SEARCH_EXPANSION_END = int(os.getenv('LADDER_SEARCH_EXPANSION_END', 60 * 60))
