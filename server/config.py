...
GEO_IP_DATABASE_URL = os.getenv("GEO_IP_DATABASE_URL", "http://geolite.maxmind.com/download/geoip/database/GeoLite2-City.mmdb.gz")
GEO_IP_DATABASE_MAX_AGE_DAYS = int(os.getenv('GEO_IP_DATABASE_MAX_AGE_DAYS', 32))
