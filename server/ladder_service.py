        ...
        if player not in self._informed_players:
            ...
            if deviation > 490:
                ...
                player.write_message({
                    ...
                    "style": "info",
                    "text": (
                        "The matchmaking system is calibrating your skill level; your first few games may be slightly more imbalanced as the system attempts to learn your capability as a player.<b><br><br>The "
                        f"learning phase is {progress:.0f}% completed<b>"
                    )
                })
